            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    ClickButton {
                        ...
                        onClicked: Quickshell.execDetached(["bash", "-c", Caching.atlanticDir + "/scripts/qs_manager.sh toggle guide"])
                    }
                    ...
                    ClickButton {
                        ...
                        onClicked: {
                            Quickshell.execDetached(["bash", Caching.atlanticDir + "/scripts/lock.sh"]);
                        }
                    }
                }
            }
                    ...
                    delegate: Rectangle {
                        ...
                        Timer {
                            ...
                            onTriggered: {
                                ...
                                let scriptPath = Caching.atlanticDir + "/scripts/system/" + (cmd === "sleep" ? "suspend.sh" : cmd + ".sh");
