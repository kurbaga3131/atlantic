...
Notification {
    ...
    fullBody: model && model.body !== "" ? model.body : "A new version of Atlantic is available."
    ...
    onCardClicked: {
        ...
        Quickshell.execDetached(["bash", Caching.atlanticDir + "/scripts/qs_manager.sh", "guide"]);
        doClose();
    }
    ...
    headerArea: [
        Text {
            ...
            text: model ? (model.displayName || model.appName || "Atlantic Updater") : "Atlantic Updater"
            font.family: ThemeBackend.fontFamily
