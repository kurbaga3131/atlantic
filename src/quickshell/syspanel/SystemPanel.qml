...
Item {
    ...
    Process {
        id: hibernateCheck
        running: false
        command: ["bash", Caching.atlanticDir + "/scripts/system/can_hibernate.sh"]
                    ...
                    RowLayout {
                        ...
                        ClickButton {
                            ...
                            Timer {
                                ...
                                onTriggered: {
                                    closeSequence.start();
                                    Quickshell.execDetached(["bash", Caching.atlanticDir + "/scripts/system/exit.sh"]);
                ...
                Item {
                    ...
                    RowLayout {
                        ...
                        QuickActionBtn {
                            ...
                            onRightClicked: {
                                closeSequence.start();
                                Quickshell.execDetached(["bash", Caching.atlanticDir + "/scripts/qs_manager.sh", "toggle", "guide", "display"]);
                            }
                        }
                        ...
                        QuickActionBtn {
                            ...
                            onRightClicked: {
                                closeSequence.start();
                                Quickshell.execDetached(["bash", Caching.atlanticDir + "/scripts/qs_manager.sh", "toggle", "guide", "idle"]);
                            }
                        }
                        ...
                        QuickActionBtn {
                            ...
                            onRightClicked: {
                                closeSequence.start();
                                Quickshell.execDetached(["bash", Caching.atlanticDir + "/scripts/qs_manager.sh", "toggle", "network", "wifi"]);
                            }
                        }
                        ...
                        QuickActionBtn {
                            ...
                            onRightClicked: {
                                closeSequence.start();
                                Quickshell.execDetached(["bash", Caching.atlanticDir + "/scripts/qs_manager.sh", "toggle", "network", "bt"]);
                            }
                        }
                        ...
                        delegate: Rectangle {
                            ...
                            Timer {
                                ...
                                onTriggered: {
                                    ...
                                    let scriptPath = cmd === "lock" ? Caching.atlanticDir + "/scripts/lock.sh" : Caching.atlanticDir + "/scripts/system/" + (cmd === "sleep" ? "suspend.sh" : cmd + ".sh");
