...
Item {
    ...
    function clearAllNotifs() {
        ...
        Quickshell.execDetached(["atlantic", "ipc", "call", "main", "clearNotifications"]);
    }
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    ImageBox {
                        ...
                        source: Caching.atlanticDir ? ("file://" + Caching.atlanticDir + "/assets/pushy.gif") : Qt.resolvedUrl("../../assets/pushy.gif")
                        isGif: true
                        playing: true
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    property string customType: {
                        ...
                        if (app === "update" || app === "updater" || app === "atlantic updater") return "update";
                        return "default";
                    }
                    ...
                    Loader {
                        ...
                        source: {
                            ...
                            if (app === "update" || app === "updater" || app === "atlantic updater") return "../notifications/types/Update.qml";
