...
Item {
    ...
    readonly property string scriptDir: Caching.atlanticDir + "/scripts/wallpaper"
    ...
    Process {
        id: monitorDetector
        running: false
        command: ["bash", Caching.atlanticDir + "/scripts/monitors_detect.sh"]
    ...
    function triggerOnlineSearch() {
        ...
        Quickshell.execDetached([
            ...
            Caching.getRunDir("wallpaper"),
            Caching.logDir,
            Caching.atlanticDir + "/scripts/wallpaper/ddg_search.sh"
        ]);
        view.forceActiveFocus();
    }
