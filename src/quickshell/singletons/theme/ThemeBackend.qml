...
Item {
    ...
    property string configPath: Quickshell.env("QS_COLORS_JSON") ?? "~/.local/state/atlantic/qs_colors.json"
    property string matugenConfigPath: (typeof Caching !== "undefined" && Caching.stateDir ? Caching.stateDir : ((Quickshell.env("HOME") ?? "") + "/.local/state/atlantic")) + "/qs_matugen_colors.json"
    ...
    Process {
        ...
        command: {
            let sys = Caching.atlanticDir ? (Caching.atlanticDir + "/assets/fonts") : "";
            let usr = Caching.stateDir ? (Caching.stateDir + "/fonts") : (Caching.home + "/.local/state/atlantic/fonts");
            let cacheFile = Caching.stateDir ? (Caching.stateDir + "/fonts_cache.txt") : (Caching.home + "/.local/state/atlantic/fonts_cache.txt");
