...
Item {
    ...
    readonly property string atlanticDir: {
        if (typeof Caching !== "undefined" && Caching.atlanticDir) {
            return Caching.atlanticDir;
        }
        return "";
    }

    readonly property string helperScript: root.atlanticDir + "/scripts/first_launch.sh"
