                        ...
                        ColumnLayout {
                            ...
                            Text {
                                text: I18n.t("guide.about.version_by", {
                                    version: (Updater.localVersion !== "..." ? Updater.localVersion : (rootObj.dotsVersion !== "Loading..." && rootObj.dotsVersion !== I18n.t("guide.about.loading") ? rootObj.dotsVersion : "...")),
                                    author: "kravorx"
                                })
                                font.family: ThemeBackend.fontFamily
                ...
                Item {
                    ...
                    ColumnLayout {
                        ...
                        ClickButton {
                            ...
                            onTriggered: Quickshell.execDetached(["xdg-open", "https://github.com/kurbaga3131/atlantic/blob/main/CHANGELOG.md"])
                        }
                        ...
                        FillButton {
                            ...
                            onTriggered: {
                                let cmd = "if command -v kitty >/dev/null 2>&1; then kitty --hold bash -c 'eval \"$(curl -fsSL https://raw.githubusercontent.com/kurbaga3131/atlantic/main/install/install.sh)\"'; else ${TERM:-xterm} -hold -e bash -c 'eval \"$(curl -fsSL https://raw.githubusercontent.com/kurbaga3131/atlantic/main/install/install.sh)\"'; fi";
                                Quickshell.execDetached(["bash", "-c", cmd]);
                                Quickshell.execDetached(["bash", rootObj.appPaths.atlanticDir + "/scripts/qs_manager.sh", "close"]);
                            }
                        }
                    }
                }
