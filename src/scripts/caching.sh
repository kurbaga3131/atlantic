...
if [ -z "$ATLANTIC_DIR" ]; then
    ...
    export ATLANTIC_DIR="$(dirname "$SCRIPT_DIR")"
fi

export QS_DIR="$ATLANTIC_DIR/quickshell"
export MAIN_QML="$QS_DIR/Shell.qml"
export IPC_SOCKET="${XDG_RUNTIME_DIR:-/tmp}/atlantic.sock"

export QS_CACHE_DIR="$HOME/.cache/atlantic"
export QS_STATE_DIR="$HOME/.local/state/atlantic"
export QS_RUN_DIR="${XDG_RUNTIME_DIR:-/tmp}/atlantic"
export QS_LOG_DIR="$QS_RUN_DIR/logs"
export QS_SETTINGS="$HOME/.config/atlantic/settings.json"
