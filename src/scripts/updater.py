...
def get_local_ver():
    ...
    if os.path.isfile(state_file):
        try:
            ...
            pass
    # Fallback: try version.txt in atlantic dir
    script_dir = os.path.dirname(os.path.abspath(__file__))
    serp_dir = os.path.dirname(script_dir)  # src/
    for vpath in [
        os.path.join(serp_dir, "version.txt"),
        os.path.join(os.path.dirname(serp_dir), "version.txt"),
    ]:
