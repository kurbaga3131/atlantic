...
- fix a local function call bug in atlanticd
...
- fix: atlantic not cleanly killing the quickshell process
...
- fix: atlantic --version flag to display version correctly on nix
