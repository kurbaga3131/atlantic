<div align="center">
  <a href="https://ko-fi.com/kurbaga3131">
    <img src="https://ko-fi.com/img/githubbutton_sm.svg" alt="ko-fi" />
  </a>
</div>

<div align="center">
  <img src="docs/assets/banner.png" alt="Atlantic" width="850" />
</div>
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/kurbaga3131/atlantic/main/install/install.sh)"
...
Atlantic provides flake outputs, a NixOS module for system dependencies, and a Home Manager module for user configuration and service management.

#### 1. Add Flake Input

Add Atlantic to your `flake.nix`:

```nix
{
  inputs = {
    nixpkgs.url = "github:nixos/nixpkgs/nixos-unstable";
    atlantic.url = "github:kurbaga3131/atlantic";
  };

  outputs = { self, nixpkgs, atlantic, ... }: {
    nixosConfigurations.nixos = nixpkgs.lib.nixosSystem {
      system = "x86_64-linux";
      specialArgs = { inherit atlantic; };
      modules = [
        ./configuration.nix
        atlantic.nixosModules.default
      ];
    };
  };
}
...

{
  environment.systemPackages = [
    atlantic.packages.${pkgs.stdenv.hostPlatform.system}.default
  ];
}
...
{
  imports = [
    atlantic.homeManagerModules.default
  ];
...
> Sample configs, autostart entries, and keybindings for supported window managers and compositors are available in the [compositors](https://github.com/kurbaga3131/atlantic/tree/master/compositors) directory.
...
To run the shell, launch `atlanticd start`
